  ...
  <footer class="footer">
    ...
    <div class="ticker">
      <div class="ticker-content">
        FIND A COURT • DONATE • FIND A COURT • JOIN A LEAGUE • SIGN UP FOR TOURNAMENTS • COMMUNITY BOARD • PICKLEBALL RULES • DONATE • FIND A COURT • JOIN A LEAGUE • SIGN UP FOR TOURNAMENTS • COMMUNITY BOARD • PICKLEBALL RULES • 
      </div>
    </div>
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-section">
            ...
            <p class="footer-tagline">Community Portal for Pickleball Enthusiasts</p>
          </div>
        ...
        <div class="footer-bottom">
          <p>&copy; 2026 SUPER (Sanpete Utah Pickleball Event Resource). All rights reserved.</p>
          <p class="footer-tagline-bottom">Community Portal for Pickleball Enthusiasts</p>
        </div>
      </div>
    </div>
  </footer>
